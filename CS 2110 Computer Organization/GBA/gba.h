...
//need width(=length of row) to flat array of 2D into 1D
#define OFFSET(row, col, width) (((col)+(width)*(row))) 	//row * width + col

#define REG_DISPCNT (*(volatile unsigned short *) 0x4000000)
#define MODE3 (3) // set bit 0 and 1
#define BG2_ENABLE (1<<10) //(1<<10) set bit 10

/* 

0 00000 (blue) 00000 (green) 00000(red)
red takes up the rightmost bits
green takes up the middle
blue takes upthe leftmost bits
